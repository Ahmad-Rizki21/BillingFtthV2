from sqlalchemy import (BigInteger, String, Date, DateTime, Text, ForeignKey, Numeric, Boolean, func, TIMESTAMP)
...
class Invoice(Base):
    ...
    invoice_number: Mapped[str] = mapped_column(String(191), unique=True) # Sesuai dengan UNIQUE KEY
