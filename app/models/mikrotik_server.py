...
from sqlalchemy.orm import Mapped, mapped_column, relationship # Pastikan relationship diimpor
...
class MikrotikServer(Base):
    ...
    last_connection_status: Mapped[str | None] = mapped_column(String(191), nullable=True) # Dibuat nullable=True
